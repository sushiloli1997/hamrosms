...
![Hamrosmslogo](https://hamrosms247.com/images/logo.png)
...
# __Developers Guide__ ,</br></br></br></br></br>
====================
</br></br></br></br></br></br>
...
- [__Developers Guide__ ,</br>](#__developers-guide__-brbrbrbrbr)
- [System Integration](#system-integration)
    - [__Below is the API detail.__](#__below-is-the-api-detail__)
  - [Request:](#request)
    - [__Request Method:__ GET](#__request-method__-get)
  - [Response](#response)
  - [__Table: response Details__](#__table-response-details__)
  - [Example:](#example)
    - [Request Method: GET](#request-method-get)
    - [__Table Response__](#__table-response__)
  - [__Response:__](#__response__)
    - [__Success Response__](#__success-response__)
    - [Example:](#example-1)
  - [__Method type :__ &nbsp; POST <br>](#__method-type-__-nbsp-post-br)
    - [__Request Body in form data:__](#__request-body-in-form-data__)
    - [__Success Response:__](#__success-response__-1)
    - [__Failure Response (when any body parameters are missing)__](#__failure-response-when-any-body-parameters-are-missing__)
    - [Error](#error)
  - [__Method type:__ &nbsp; POST <br>](#__method-type__-nbsp-post-br)
  - [__Request Body in form data:__](#__request-body-in-form-data__-1)
    - [__Success Response:__](#__success-response__-2)
    - [__Failure Response (When any body parameters are missing )__](#__failure-response-when-any-body-parameters-are-missing-__)
